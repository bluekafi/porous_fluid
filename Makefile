...
edit:
	geany -i  src/algo/determine.h src/algo/determine.cpp src/drw/bmp.h src/drw/bmp.cpp src/dst/mns.h src/dst/mns.cpp src/dst/parameter.h src/dst/parameter.cpp src/exe/incongen.cpp src/exe/plot.cpp src/exe/simulate.cpp src/exe/test.cpp src/head/decl.h src/head/type.h src/incongen/manager.h src/incongen/manager.cpp src/io/cmdprint.h src/io/cmdprint.cpp src/io/cmdread.h src/io/cmdread.cpp src/io/fileplot.h src/io/fileplot.cpp src/io/fileread.h src/io/fileread.cpp src/io/filewrite.h src/io/filewrite.cpp src/math/gausslinear.h src/math/gausslinear.cpp src/math/random.h src/math/random.cpp src/measure/measure.h src/measure/measure.cpp src/network/dimension.h src/network/dimension.cpp src/simulate/manager.h src/simulate/manager.cpp src/smlsteps/01pressure.h src/smlsteps/01pressure.cpp src/smlsteps/02velocity.h src/smlsteps/02velocity.cpp src/smlsteps/03timestep.h src/smlsteps/03timestep.cpp src/smlsteps/04displacement.h src/smlsteps/04displacement.cpp


run/incongen: build/exe_incongen.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o
	g++  build/exe_incongen.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o -o run/incongen
	@echo "build/exe_incongen.o created."


run/plot: build/exe_plot.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o
	g++  build/exe_plot.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o -o run/plot
	@echo "build/exe_plot.o created."


run/simulate: build/exe_simulate.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o
	g++  build/exe_simulate.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o -o run/simulate
	@echo "build/exe_simulate.o created."


run/test: build/exe_test.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o
	g++  build/exe_test.o build/algo_determine.o build/drw_bmp.o build/dst_mns.o build/dst_parameter.o build/incongen_manager.o build/io_cmdprint.o build/io_cmdread.o build/io_fileplot.o build/io_fileread.o build/io_filewrite.o build/math_gausslinear.o build/math_random.o build/measure_measure.o build/network_dimension.o build/simulate_manager.o build/smlsteps_01pressure.o build/smlsteps_02velocity.o build/smlsteps_03timestep.o build/smlsteps_04displacement.o -o run/test
